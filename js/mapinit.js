const map = L.map('map', { attributionControl: false, minZoom: 6, zoomControl: false }).setView([47.184, 19.509], 8);

L.control.zoom({ position: 'topleft', zoomInText: '<div class="navy-button"><img src="/icons/plus.svg" alt></div>', zoomOutText: '<div class="navy-button"><img src="/icons/minus.svg" alt></div>' }).addTo(map);
